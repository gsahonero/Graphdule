...
export const AttentionReviewView: React.FC = () => {
  ...
  if (!attentionSystemEnabled) {
    return (
      <div className="flex-1 overflow-y-auto p-6 md:p-12 flex flex-col items-center justify-center text-center bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100">
        <div className="max-w-xl bg-white dark:bg-slate-900/80 border border-slate-200 dark:border-slate-800 rounded-3xl p-8 md:p-10 shadow-xl backdrop-blur-sm">
          <div className="w-16 h-16 rounded-2xl bg-amber-500/10 border border-amber-500/30 flex items-center justify-center text-amber-600 dark:text-amber-400 mx-auto mb-6">
            <Clock className="w-8 h-8" />
          </div>

          <h2 className="text-2xl md:text-3xl font-bold tracking-tight text-slate-900 dark:text-slate-100 mb-3">
            Attention Measurement System
          </h2>

          <p className="text-slate-600 dark:text-slate-400 text-sm md:text-base leading-relaxed mb-6">
            Graphdule is built on the principle that ideas are unlimited, projects are manageable, but <strong className="text-amber-700 dark:text-amber-400 font-semibold">attention is limited</strong>.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3 text-left mb-8">
            <div className="p-3.5 rounded-xl bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700/50">
              <span className="text-xs font-semibold text-amber-700 dark:text-amber-400 block mb-1">Attention Unit (AU)</span>
              <p className="text-xs text-slate-600 dark:text-slate-300">
                1 AU represents {attentionUnitMinutes} minutes of focused work. Fully customizable to fit your rhythm.
              </p>
            </div>
            <div className="p-3.5 rounded-xl bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700/50">
              <span className="text-xs font-semibold text-emerald-700 dark:text-emerald-400 block mb-1">Work Clock</span>
              <p className="text-xs text-slate-600 dark:text-slate-300">
                Track explicitly when you work. Actual attention is never inferred from calendar days.
              </p>
            </div>
            <div className="p-3.5 rounded-xl bg-slate-50 dark:bg-slate-800/50 border border-slate-700/50">
              <span className="text-xs font-semibold text-cyan-700 dark:text-cyan-400 block mb-1">Weekly Review</span>
              <p className="text-xs text-slate-600 dark:text-slate-300">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
            <button
              ...
              className="w-full sm:w-auto px-6 py-3 bg-amber-500 hover:bg-amber-400 text-slate-950 font-bold rounded-xl shadow-lg shadow-amber-500/20 transition-all flex items-center justify-center gap-2 cursor-pointer"
            >
  ...
  return (
    <div className="flex-1 flex flex-col overflow-hidden bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100">
      {/* Top Header & Toolbar */}
      <div className="border-b border-slate-200 dark:border-slate-800 bg-white/90 dark:bg-slate-900/60 backdrop-blur-md px-6 py-4 flex flex-wrap items-center justify-between gap-4">
        <div>
          <div className="flex items-center gap-2">
            ...
            <span className="px-2 py-0.5 rounded-md bg-amber-500/10 border border-amber-500/30 text-amber-700 dark:text-amber-400 text-xs font-semibold">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          {/* Week Selector */}
          <div className="flex items-center bg-slate-100 dark:bg-slate-800/80 border border-slate-200 dark:border-slate-700/60 rounded-xl p-1 text-xs">
            <button
              onClick={() => {
            ...
            <span className="px-3 font-medium text-slate-800 dark:text-slate-200">
            ...
            <button
              ...
              className="p-1.5 hover:bg-slate-200 dark:hover:bg-slate-700 disabled:opacity-30 disabled:hover:bg-transparent rounded-lg text-slate-600 dark:text-slate-300 transition-colors cursor-pointer"
              title="Next Week"
            >
            ...
            {weekOffset !== 0 && (
              <button
                ...
                className="ml-1 px-2 py-1 bg-slate-200 dark:bg-slate-700 hover:bg-slate-300 dark:hover:bg-slate-600 rounded-md text-[11px] font-medium text-slate-700 dark:text-slate-200 cursor-pointer"
              >
                Current
              </button>
            )}
          ...
          <button
            ...
            className="px-4 py-2 bg-amber-500 hover:bg-amber-400 disabled:opacity-50 text-slate-950 font-semibold rounded-xl text-xs shadow-md shadow-amber-500/10 transition-all flex items-center gap-1.5 cursor-pointer"
          ...
          <button
            ...
            className="p-2 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 border border-slate-200 dark:border-slate-700/80 rounded-xl text-slate-600 dark:text-slate-300 transition-colors cursor-pointer"
      ...
      {showConfig && (
        <div className="bg-white dark:bg-slate-900/90 border-b border-slate-200 dark:border-slate-800 px-6 py-4 grid grid-cols-1 sm:grid-cols-3 gap-4 text-xs animate-in slide-in-from-top-2 duration-150">
          <div>
            ...
            <select
              ...
              className="w-full bg-slate-50 dark:bg-slate-800 border border-slate-300 dark:border-slate-700 rounded-lg px-3 py-1.5 text-slate-800 dark:text-slate-200 focus:outline-none focus:border-amber-500"
            >
          ...
          <div className="flex items-end">
            <button
              ...
              className="w-full py-2 bg-slate-100 dark:bg-slate-800 hover:bg-rose-50 dark:hover:bg-rose-950/40 text-rose-600 dark:text-rose-400 border border-rose-200 dark:border-rose-900/40 rounded-lg font-medium transition-colors cursor-pointer"
            >
      ...
      <div className="flex-1 overflow-y-auto p-6 space-y-6">
        ...
        {selectedHistoricalReviewId && (
          <div className="bg-amber-50 dark:bg-amber-500/10 border border-amber-300 dark:border-amber-500/30 rounded-2xl p-3.5 flex items-center justify-between text-xs text-amber-900 dark:text-amber-300">
            <div className="flex items-center gap-2">
              <History className="w-4 h-4 text-amber-600 dark:text-amber-400 flex-shrink-0" />
              <span>
            ...
            <button
              ...
              className="px-2.5 py-1 bg-amber-200/70 hover:bg-amber-200 text-amber-950 dark:bg-amber-500/20 dark:hover:bg-amber-500/30 dark:text-amber-200 rounded-lg transition-colors font-medium cursor-pointer"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div className="p-5 rounded-2xl bg-white dark:bg-slate-900/70 border border-slate-200 dark:border-slate-800/80 shadow-xs dark:shadow-lg relative overflow-hidden">
            <div className="flex items-center justify-between text-slate-500 dark:text-slate-400 mb-2 text-xs">
              <span className="font-semibold uppercase tracking-wider text-slate-500 dark:text-slate-400">Tracked Attention</span>
            ...
            <div className="flex items-baseline gap-2">
              ...
              <span className="text-amber-600 dark:text-amber-400 font-bold text-sm">AU</span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div className="bg-white dark:bg-slate-900/70 border border-slate-200 dark:border-slate-800/80 rounded-2xl p-5 shadow-xs dark:shadow-lg">
            <h2 className="text-sm font-bold uppercase tracking-wider text-slate-800 dark:text-slate-300 mb-4 flex items-center gap-2">
              ...
              <div className="space-y-3.5">
                    ...
                    <div className="flex items-center justify-between text-xs">
                      <div className="flex items-center gap-2">
                        <button
                          ...
                          className="font-medium text-slate-800 dark:text-slate-200 hover:text-amber-600 dark:hover:text-amber-400 transition-colors text-left cursor-pointer"
                        >
                          {p.projectName}
                        </button>
                        {p.isAttention && (
                          <span className="px-1.5 py-0.2 rounded bg-amber-100 text-amber-800 dark:bg-amber-500/10 dark:text-amber-400 text-[10px] font-semibold border border-amber-300 dark:border-amber-500/20">
                            Attention Focus
                          </span>
                        )}
                      </div>
                      <div className="flex items-center gap-2 font-mono">
                        <span className="text-slate-800 dark:text-slate-200 font-semibold">{Math.round(p.au * 100) / 100} AU</span>
                ...
                {activeReviewData.standaloneAllocations.au > 0 && (
                  <div className="space-y-1 pt-2 border-t border-slate-200 dark:border-slate-800">
                    <div className="flex items-center justify-between text-xs">
                      <span className="font-medium text-slate-700 dark:text-slate-300">Standalone Tasks</span>
                      <div className="flex items-center gap-2 font-mono">
            ...
            {activeReviewData.topTasksByAttention.length === 0 ? (
              ...
              <div className="space-y-2.5">
                {activeReviewData.topTasksByAttention.map((t, idx) => (
                  <div
                    key={t.taskId}
                    className="flex items-center justify-between p-2.5 rounded-xl bg-slate-50 dark:bg-slate-800/40 border border-slate-200 dark:border-slate-700/40 text-xs"
                  >
                    <div className="flex items-center gap-2.5 min-w-0 pr-2">
                      <span className="font-mono text-slate-400 dark:text-slate-500 font-bold text-[11px] w-4">
                        #{idx + 1}
                      </span>
                      <div className="min-w-0">
                        <p className="font-medium text-slate-800 dark:text-slate-200 truncate">{t.taskText}</p>
                        {t.projectName && (
                          <p className="text-[10px] text-amber-700 dark:text-amber-300/70 truncate">{t.projectName}</p>
                        )}
                      </div>
                    </div>
                    <div className="flex items-center gap-2 flex-shrink-0 font-mono">
                      <span className="text-amber-600 dark:text-amber-400 font-semibold">{Math.round(t.au * 100) / 100} AU</span>
        ...
        <div className="bg-white dark:bg-slate-900/70 border border-slate-200 dark:border-slate-800/80 rounded-2xl p-5 shadow-xs dark:shadow-lg space-y-4">
              ...
              {activeReviewData.patternObservations.map((obs) => {
                ...
                return (
                  <div
                    ...
                    className="p-4 rounded-xl bg-slate-50 hover:bg-slate-100 dark:bg-slate-800/40 dark:hover:bg-slate-800/60 border border-slate-200 dark:border-slate-700/60 cursor-pointer transition-all"
                  >
                    <div className="flex items-start justify-between gap-2">
                      ...
                      <span className="text-[10px] text-slate-500 dark:text-slate-400 underline decoration-slate-300 dark:decoration-slate-600">
                    ...
                    {/* Evidence summary */}
                    <div className="flex items-center gap-3 mt-3 pt-2.5 border-t border-slate-200 dark:border-slate-700/40 text-[11px] text-slate-600 dark:text-slate-400">
                      {obs.evidence.map((ev, i) => (
                        <div key={i}>
                          <span className="text-slate-500">{ev.label}: </span>
                          <span className="font-semibold text-slate-800 dark:text-slate-300 font-mono">{ev.value}</span>
                        </div>
                      ))}
                    </div>
                    ...
                    {isExpanded && (
                      <div className="mt-3 p-2.5 rounded-lg bg-slate-100 dark:bg-slate-950/80 border border-slate-200 dark:border-slate-800 text-[11px] text-amber-800 dark:text-amber-300 font-mono">
        ...
        {attentionReviews.length > 0 && (
          <div className="bg-white dark:bg-slate-900/70 border border-slate-200 dark:border-slate-800/80 rounded-2xl p-5 shadow-xs dark:shadow-lg">
            <h2 className="text-sm font-bold uppercase tracking-wider text-slate-800 dark:text-slate-300 mb-3 flex items-center gap-2">
                ...
                <div
                  ...
                  className={`p-3 rounded-xl border transition-all flex flex-col justify-between ${
                    selectedHistoricalReviewId === rev.id
                      ...
                      : 'bg-slate-50 border-slate-200 hover:bg-slate-100 dark:bg-slate-800/40 dark:border-slate-700/50 dark:hover:bg-slate-800/70'
                  }`}
                >
                  <div>
                    <div className="flex items-center justify-between text-xs">
                    ...
                    {rev.userNotes && (
                      <p className="text-[11px] text-slate-700 dark:text-slate-300 mt-1.5 italic line-clamp-2">
                        "{rev.userNotes}"
                      </p>
                    )}
                  </div>
                  ...
                  <button
                    ...
                    className="mt-3 w-full py-1 bg-slate-200 hover:bg-slate-300 text-slate-800 dark:bg-slate-700/50 dark:hover:bg-slate-700 dark:text-slate-200 text-xs font-medium rounded-lg transition-colors"
                  >
                    Inspect Snapshot
                  </button>
                </div>
