...
export const ProjectDetailView: React.FC = () => {
  ...
  return (
    <div className="flex-1 flex flex-col h-full overflow-hidden dark:bg-slate-950 bg-slate-50 transition-colors duration-150">
      ...
      <div className="h-14 bg-white/90 dark:bg-slate-900/60 border-b border-slate-200 dark:border-slate-800 px-4 flex items-center justify-between z-20 shrink-0 backdrop-blur-md">
            ...
            {isEditingTitle ? (
              <div className="flex items-center space-x-1.5 animate-in fade-in">
                <input
                  ...
                  className="px-2.5 py-1 text-sm font-bold bg-slate-50 dark:bg-slate-950 border border-emerald-500 rounded-md text-slate-900 dark:text-slate-100 focus:outline-none focus:ring-1 focus:ring-emerald-400 shadow-inner max-w-xs sm:max-w-md"
                />
                <button
              ...
              <div
                ...
                className="group flex items-center space-x-2 cursor-pointer p-1 -m-1 rounded-md hover:bg-slate-100 dark:hover:bg-slate-800/60 transition-colors shrink-0"
                title="Click to rename project"
              >
                <h2 className="font-bold text-sm text-slate-800 dark:text-slate-100 truncate max-w-[200px] sm:max-w-xs">
                  {project.name}
                </h2>
        ...
        {/* Center: Tabs */}
        <div id="nav-tabs" className="flex items-center bg-slate-100 dark:bg-slate-950/80 p-1 rounded-lg border border-slate-200 dark:border-slate-800 shrink-0">
          <button
        ...
        <div className="flex items-center space-x-3 shrink-0">
          ...
          {isArchived ? (
            <button
              ...
              className="flex items-center space-x-1.5 px-3 py-1.5 rounded-lg text-xs font-medium bg-emerald-50 dark:bg-emerald-950/60 hover:bg-emerald-100 dark:hover:bg-emerald-900/60 text-emerald-700 dark:text-emerald-300 border border-emerald-300 dark:border-emerald-700 transition-colors cursor-pointer shadow-xs"
            ...
            <button
              ...
              className="flex items-center space-x-1.5 px-3 py-1.5 rounded-lg text-xs font-medium bg-slate-100 dark:bg-slate-900 hover:bg-slate-200 dark:hover:bg-slate-800 text-slate-700 dark:text-slate-300 border border-slate-300 dark:border-slate-800 transition-colors cursor-pointer shadow-xs"
