...
export const WorkButton: React.FC<WorkButtonProps> = ({
  ...
  if (isCurrentActive) {
    return (
      <div
        className="inline-flex items-center gap-1 bg-amber-500/15 dark:bg-amber-500/20 border border-amber-500/40 rounded-full px-2 py-0.5 text-xs font-medium text-amber-300"
  ...
  return (
    <button
      onClick={handleToggle}
      className={`group inline-flex items-center gap-1 rounded-full border border-slate-700/60 dark:border-slate-700/60 bg-slate-800/40 hover:bg-amber-500/10 hover:border-amber-500/40 text-slate-400 hover:text-amber-300 transition-all font-medium ${
